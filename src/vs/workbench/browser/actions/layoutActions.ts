...
import { ToggleSimulatorAction } from '../parts/simulator/simulatorActions.js';
...
ToggleVisibilityActions.push(...[
	...
	CreateToggleLayoutItem(ToggleSimulatorAction.ID, PanelVisibleContext, localize('panel', "Panel"), panelIcon),
